...
提供一个无需登录即可使用的语音合成服务，支持实时字数限制提示和历史记录功能。
...
### 新增功能 🔥
- 🆕 **实时字数限制提示**：输入框边框根据字数状态变色（绿色正常/黄色接近限制/红色超限），显示当前字符数/最大限制及可视化进度条
- 🆕 **历史记录功能**：自动保存最近 10 条生成记录到本地存储，支持快速恢复文本和方言设置，可删除单条或清空全部历史
...
1. 文本长度限制为 500 字符（带实时字数提示）
2. 无使用次数限制（开源版）
3. 无用户认证功能
4. 无付费功能
5. 历史记录保存在本地浏览器存储中（最多 10 条）
